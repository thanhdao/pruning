...
Wiki
Insights
pytorch-segmentation-detection/pytorch_segmentation_detection/utils/flops_benchmark.py
9d26b11 on Mar 14, 2018
@warmspringwinds warmspringwinds added comment about the details of flops computation
268 lines (152 sloc) 7.29 KB
import torch
